...
![Histograma das Alturas (Normal Aproximada)](../images/histograma_normal.png){width=80% style="margin-bottom: 2rem;"}
...
![Q-Q Plot das Alturas](../images/qqplot_normal.png){width=80% style="margin-bottom: 2rem;"}
